...
public class Babarege extends AppCompatActivity implements AllFragmentDataAdpr.OnItemClickListener {
    ...
    private void LoadCardData(){
        SharedPreferences sharedPref = getSharedPreferences("STORE_PRODUCT_DETAILS_DATA", Context.MODE_PRIVATE);
        loadCardCount= sharedPref.getInt("productQuantityForThis", 0);
